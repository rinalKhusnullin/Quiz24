	...
	var QuizList = /*#__PURE__*/function () {
	  ...
	  babelHelpers.createClass(QuizList, [{
	    ...
	    value: function getShareNode(quiz) {
	      var quizTakeLink = "".concat(location.host, "/quiz/").concat(quiz.CODE, "/take");
